                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="text-center">
                                            <img
                                                src="{{ $vendor -> photo }}"
                                                class="rounded-circle height-150" alt="صوره التاجر">
                                        </div>
                                    </div>
                                    ...
                                    <input type="hidden" name="id" value="{{ $vendor->id }}"> 
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput">إختر القسم</label>
                                                        <select name="category_id" class="select2 form-control">
                                                            <optgroup lable="من فضلك اختر القسم">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 ">
                                                    <div class="form-group">
                                                        <label for="projectinput1">ادخل الرقم السرى</label>
